...
class ProductDetailsAdapter(var callback: Callback) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): RecyclerView.ViewHolder {
        ...
        when (viewType) {
            ViewTypeHelper.TITLE.ordinal -> return TitleViewHolder.newInstance(parent)
            ViewTypeHelper.LABEL_VALUE.ordinal -> return LabelValueViewHolder.newInstance(parent)
